...
#define     MathProgId    "NCMV.MathLib"
...
HRESULT  __stdcall DllRegisterServer(void)
{
	...
	wsprintf(szProgId,"%s\\%s",MathProgId,"CLSID");
	HelperWriteKey (
				HKEY_CLASSES_ROOT,
				szProgId,
				NULL,
...
HRESULT  __stdcall DllUnregisterServer(void)
{
	...
	//
	wsprintf(szKeyName,"%s\\%s",MathProgId,"CLSID");
	RegDeleteKey(HKEY_CLASSES_ROOT,szKeyName);
	RegDeleteKey(HKEY_CLASSES_ROOT,MathProgId);
